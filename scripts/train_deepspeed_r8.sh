...
DEFAULT_SEED=0
DEFAULT_OUTPUT_DIR="output_deepspeed_r8_seed0"
...
echo "Training r8 dataset with DeepSpeed ZeRO-$ZERO_STAGE (seed: $SEED)"
...
echo ""
echo "DeepSpeed training completed! Check for best models in: $OUTPUT_DIR"
echo "Look for directories starting with 'best_model_' for optimal models"
